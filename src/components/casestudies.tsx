...
export default function CaseStudies() {
    return (
               <section className="flex flex-col my-18">
           <div className="flex flex-col md:flex-row gap-5 md:gap-10 items-center justify-center xl:justify-start md:mb-18">
...
<div className="flex flex-row no-wrap w-full overflow-x-auto touch-pan-x snap-x snap-mandatory scrollbar-hide lg:overflow-x-visible xl:h-[326] lg:rounded-[2.5rem] lg:bg-foreground lg:px-[60px] lg:py-[70px] mx-0 my-5 items-start gap-4 lg:gap-16">
  ...
  <Image
    ...
    <div className="hidden md:block w-0.5 h-[186px] bg-white"></div>
